...
modOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "modOptions",
...
modResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "modResults",
...
modBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "modBase",
